...
namespace BalloonSim.UI
{
    public class SimUIOnGUI : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            string pmse = autopilot != null && config.aiEnabled ? autopilot.PredMSE.ToString("F4") : "-";
            ...
            string stage2Line = $"Stage2 predictor: mode={model} status={status} ms={ms} modelSrc={modelSrc} normSrc={normSrc}";
